To run the server, open Terminal (for Mac) or Command Prompt (for Windows). Navigate to the folder lab2/activity_0 using for example, cd CMSC734_final_project.
